...
function Definitions()
	...
	{
		"StructureForce",
		"Rebel_Ground_Mining_Facility | Empire_Ground_Mining_Facility | U_Ground_Mining_Facility | Underworld_Bank_Building | Imperial_Bank_Building | Rebel_Bank_Building = 1"
	}
	}
