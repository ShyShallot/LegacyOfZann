...
function Definitions()
	...
	Attack_Ability_Type_Names = { 
		"Generic_Field_Commander_Rebel", "Generic_Field_Commander_Empire", "Generic_Fleet_Commander_Rebel", "Generic_Fleet_Commander_Empire", "Generic_Smuggler_R", "Generic_Smuggler_E"		-- Attack these types.
	}
